...
```bash
bash <(curl -sSL [https://github.com/ariadata/proxmox-hetzner/raw/main/scripts/pve-install.sh](https://raw.githubusercontent.com/pschaufelberger/proxmox-hetzner/refs/heads/main/scripts/pve-install.sh))
```
